...
export PATH=$PATH:$GOBI

# The next line updates PATH for the Google Cloud SDK.
if [ -f /data/data/com.termux/files/usr/google-cloud-sdk/path.bash.inc ]; then
  source '/data/data/com.termux/files/usr/google-cloud-sdk/path.bash.inc'
fi
